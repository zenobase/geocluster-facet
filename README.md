...
To install the plugin, run: `bin/plugin --url https://github.com/zenobase/geocluster-facet/releases/download/x.x.x/geocluster-facet-x.x.x.jar --install geocluster-facet`
